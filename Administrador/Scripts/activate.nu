...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Patrick\Desktop\pbl-redes-2\Administrador\administrador'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Patrick\Desktop\pbl-redes-2\Administrador\administrador\Scripts\deactivate.nu'
